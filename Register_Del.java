...
public class Register_Del extends AppCompatActivity {
    ...
    String fname,email,password,confpassword,mobile,house,area,Pincode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register_del);
        ...
        mobileno = (TextInputLayout)findViewById(R.id.Mobileid);
        houseno = (TextInputLayout)findViewById(R.id.street);
        pincode = (TextInputLayout)findViewById(R.id.Pincode);

        area = String.valueOf((TextInputLayout)findViewById(R.id.Area));

        signup = (Button)findViewById(R.id.btn2);
        Emaill = (Button)findViewById(R.id.emailid);
        Phone = (Button)findViewById(R.id.phoneno);
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isValid()){
                    final ProgressDialog mDialog = new ProgressDialog(Register_Del.this);
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        ...
                                                        FAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                            ...
                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                ...
                                                                if(task.isSuccessful()){
                                                                    AlertDialog.Builder builder = new AlertDialog.Builder(Register_Del.this);
                                                                    ...
                                                                    builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                                                        ...
                                                                        public void onClick(DialogInterface dialog, int which) {
                                                                            ...
                                                                            Intent b = new Intent(Register_Del.this,Delivery_VerifyPhone.class);
                                                                    ...
                                                                    mDialog.dismiss();
                                                                    ReusableCodeForAll.ShowAlert(Register_Del.this,"Error",task.getException().getMessage());
                                                                }
                                                            }
                                                        });
        ...
        Emaill.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Register_Del.this,login_Del.class));
                finish();
            }
        });
        Phone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Register_Del.this,loginphone_Del.class));
                finish();
            }
        });
    }
