...
public class Registercustomer extends AppCompatActivity {
    TextInputLayout Fname,Email,Pass,cpass,mobileno,localaddress,area,pincode;
    ...
    String fname,emailid,password,confpassword,mobile,Localaddress,Area,Pincode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Pass = (TextInputLayout)findViewById(R.id.Pwdid);
        cpass = (TextInputLayout)findViewById(R.id.Cpassid);
        mobileno = (TextInputLayout)findViewById(R.id.Mobile);
        localaddress = (TextInputLayout)findViewById(R.id.street);
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isValid()){
                    final ProgressDialog mDialog = new ProgressDialog(Registercustomer.this);
                                                                ...
                                                                if(task.isSuccessful()){
                                                                    ...
                                                                    builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                                                        ...
                                                                        public void onClick(DialogInterface dialog, int which) {
                                                                            ...
                                                                            Intent b = new Intent(Registercustomer.this,loginverify.class);
                                                                    ...
                                                                    mDialog.dismiss();
                                                                    ReusableCodeForAll.ShowAlert(Registercustomer.this,"Error",task.getException().getMessage());
                                                                }
                                                            }
                                                        });
        ...
        Phone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Registercustomer.this,loginphone.class));
                finish();
            }
        });
