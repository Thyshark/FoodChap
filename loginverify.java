...
public class loginverify extends AppCompatActivity {
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks mcallBack=new PhoneAuthProvider.OnVerificationStateChangedCallbacks(){
        ...
        public void onVerificationFailed(@NonNull FirebaseException e) {
            Toast.makeText(loginverify.this , e.getMessage(),Toast.LENGTH_LONG).show();
                ...
                .addOnCompleteListener(loginverify.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful()){
                            ...
                            Intent intent = new Intent(loginverify.this , MainMenu.class);
                            startActivity(intent);
                            finish();
                        }else{
                            ReusableCodeForAll.ShowAlert(loginverify.this,"Error",task.getException().getMessage());
                        }
                    }
                });
